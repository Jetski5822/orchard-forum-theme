...
(function ($) {
    ...
    function textAreaResizer(target, opts) {
        ...
        var originalPos, originalDivHeight;
        ...
        function startDrag(e) {
            ...
            originalPos = mousePosition(e).y;
            originalDivHeight = wrapper.height();
            
            overlay.width(wrapper.width());
            overlay.height(originalDivHeight);
        ...
        function performDrag(e) {
            var iThisMousePos = mousePosition(e).y,
                ...
                resizing,
                size = originalDivHeight + (originalPos - iThisMousePos);
            ...
            size = Math.max(defaults.minHeight, size);
            var sizePx = size + "px";
            
            resizing.height(sizePx);
            //overlay.height(sizePx);
